...
namespace Vision_Core
{
    ...
    public class CHCNetSDK
    {
        ...
        public const int MAX_CAsdkET_COUNT = 8;    //×î´óÖ§³Ö»ú¹ñÊýÁ¿
        ...
        public const int NET_DVR_sdkDSOCKET_ERROR = 72;//°ó¶¨Ì×½Ó×ÖÊ§°Ü
        ...
        **************************************************/
        ...
        public const int COMM_ALARMHOST_SAFETYCAsdkSTATE = 0x1125;	 //·À»¤²Õ×´Ì¬
        public const int COMM_ALARMHOST_ALARMOUTSTATUS = 0x1126;	 //±¨¾¯Êä³ö¿Ú/¾¯ºÅ×´Ì¬
        public const int COMM_ALARMHOST_CID_ALARM = 0x1127;	 //±¨¸æ±¨¾¯ÉÏ´«
        ...
        **************************************************/
        ...
        public struct UNION_ALARMINFO_FIXED
        {
            ...
            [FieldOffset(0)]
            public STRUCT_IO_ALARM struIOAlarm;// ±¨¾¯ÀàÐÍdwAlarmTypeÎª0Ê±ÓÐÐ§
            [FieldOffset(0)]
            public STRUCT_ALARM_CHANNEL struAlarmChannel; // dwAlarmTypeÎª2£¬3£¬6£¬9£¬10»ò13Ê±ÓÐÐ§
            [FieldOffset(0)]
            public STRUCT_ALARM_HD struAlarmHardDisk; // dwAlarmTypeÎª1,4,5Ê±ÓÐÐ§           
        }
        ...
        public struct NET_DVR_WORKSTATE_V40
        {
            ...
            public uint[] byAudioInChanStatus;		//°´Î»±íÊ¾ÓïÒôÍ¨µÀµÄ×´Ì¬ 0-Î´Ê¹ÓÃ£¬1-Ê¹ÓÃÖÐ£¬µÚ0Î»±íÊ¾µÚ1¸öÓïÒôÍ¨µÀ
        ...
        {
            public uint dwWorkType;/*¹¤×÷·½Ê½£º1£ºÂÖÑ²¡¢2£º¶¯Ì¬Á¬½Ó½âÂë¡¢3£ºÎÄ¼þ»Ø·ÅÏÂÔØ 4£º°´Ê±¼ä»Ø·ÅÏÂÔØ*/
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
            public string sDVRIP;/*Á¬½ÓµÄÉè±¸ip*/
            public ushort wDVRPort;/*Á¬½Ó¶Ë¿ÚºÅ*/
            public byte byChannel;/* Í¨µÀºÅ */
            public byte byLinkMode;/* Á¬½ÓÄ£Ê½ */
            public uint dwLinkType;/*Á¬½ÓÀàÐÍ 0£­Ö÷ÂëÁ÷ 1£­×ÓÂëÁ÷*/
        ...
        {
            public byte byEapolVersion; //EAPOL°æ±¾£¬0-°æ±¾1£¬1-°æ±¾2
            public byte byAuthType; //ÄÚ²¿ÈÏÖ¤·½Ê½£¬0-PAP£¬1-MSCHAPV2
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byAnonyIdentity; //ÄäÃûÉí·Ý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byUserName; //ÓÃ»§Ãû
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byPassword; //ÃÜÂë
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 44, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        } //WPA-enterprise/WPA2-enterprisÄ£Ê½ÊÊÓÃ

        [StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        public struct UNION_EAP_PEAP
        {
            public byte byEapolVersion; //EAPOL°æ±¾£¬0-°æ±¾1£¬1-°æ±¾2
            public byte byAuthType; //ÄÚ²¿ÈÏÖ¤·½Ê½£¬0-GTC£¬1-MD5£¬2-MSCHAPV2
            public byte byPeapVersion; //PEAP°æ±¾£¬0-°æ±¾0£¬1-°æ±¾1
            public byte byPeapLabel; //PEAP±êÇ©£¬0-ÀÏ±êÇ©£¬1-ÐÂ±êÇ©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byAnonyIdentity; //ÄäÃûÉí·Ý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byUserName; //ÓÃ»§Ãû
        ...
        public struct UNION_EAP_TLS
        {
            ...
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byIdentity; //Éí·Ý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byPrivateKeyPswd; //Ë½Ô¿ÃÜÂë
        ...
        {
            [FieldOffsetAttribute(0)]
            public UNION_EAP_TTLS EAP_TTLS;//WPA-enterprise/WPA2-enterprisÄ£Ê½ÊÊÓÃ

            [FieldOffsetAttribute(0)]
            public UNION_EAP_PEAP EAP_PEAP; //WPA-enterprise/WPA2-enterprisÄ£Ê½ÊÊÓÃ
        ...
        {
            public uint dwAuthentication;/*0 -¿ª·ÅÊ½ 1-¹²ÏíÊ½*/
            public uint dwKeyLength;/* 0 -64Î»£»1- 128Î»£»2-152Î»*/
            public uint dwKeyType;/*0 16½øÖÆ;1 ASCI */
            public uint dwActive;/*0 Ë÷Òý£º0---3±íÊ¾ÓÃÄÄÒ»¸öÃÜÔ¿*/
        ...
        {
            public uint dwKeyLength;/*8-63¸öASCII×Ö·û*/
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = WIFI_WPA_PSK_MAX_KEY_LENGTH)]
            public string sKeyInfo;
            public byte byEncryptType;/*WPA/WPA2Ä£Ê½ÏÂ¼ÓÃÜÀàÐÍ,0-AES, 1-TKIP*/
        }

        [StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        public struct UNION_WPA_WPA2
        {
            public byte byEncryptType;  /*¼ÓÃÜÀàÐÍ,0-AES, 1-TKIP*/
            public byte byAuthType; //ÈÏÖ¤ÀàÐÍ£¬0-EAP_TTLS,1-EAP_PEAP,2-EAP_TLS
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        ...
        {
            public NET_DVR_WIFIETHERNET struEtherNet;/*wifiÍø¿Ú*/
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = IW_ESSID_MAX_SIZE)]
            public string sEssid;/*SSID*/
            public uint dwMode;/* 0 mange Ä£Ê½;1 ad-hocÄ£Ê½£¬²Î¼û*/
            public uint dwSecurity;/*0 ²»¼ÓÃÜ£»1 wep¼ÓÃÜ£»2 wpa-psk; */
            [StructLayoutAttribute(LayoutKind.Explicit)]
            public struct key
            {
                [FieldOffsetAttribute(0)]
                ...
                [FieldOffsetAttribute(0)]
                public UNION_WPA_WPA2 wpa_wpa2;//WPA-enterprise/WPA2-enterprisÄ£Ê½ÊÊÓÃ
            }
        }
        ...
        public struct NET_DVR_SLAVE_CHANNEL_UNION
        {
            ...
            [FieldOffsetAttribute(0)]
            public uint dwLocalChannel;    //±¾»úÍ¨µÀ
            [FieldOffsetAttribute(0)]
            public NET_DVR_CHANNEL struRemoteChannel; //Ô¶³ÌÍ¨µÀ
        }
        ...
        public struct NET_DVR_TRACK_MODE
        {
            ...
            public struct uModeParam
            {
                ...
                public uint[] dwULen;
                [FieldOffsetAttribute(0)]
                public NET_DVR_MANUAL_CTRL_INFO struManualCtrl;//ÊÖ¶¯¸ú×Ù½á¹¹
            }
        }
        ...
        public struct NET_DVR_MOUNT_PARAM_UNION
        {
            ...
            [FieldOffsetAttribute(0)]
            public NET_DVR_IDENTIFICATION_PARAM struIdentificationParam;//(SMB/CIFSÊ±ÉúÐ§)
        }
        ...
        public struct NET_DVR_MOUNTMETHOD_PARAM_UNION
        {
            ...
            public byte[] uLen; //ÁªºÏÌå½á¹¹´óÐ¡   
            [FieldOffsetAttribute(0)]
            public NET_DVR_NAS_MOUNT_PARAM struNasMountParam;//NAS¹ÒÔØ·½Ê½ (byNetDiskTypeÎªNFS(NAS)Ê±ÉúÐ§) 
        }
        ...
        {
            public ushort wMajorType;//Ö÷ÀàÐÍMA
            public ushort wMinorType;//´ÎÀàÐÍ
            public NET_DVR_TIME struStartTime;//ÊÂ¼þ¿ªÊ¼µÄÊ±¼ä
            public NET_DVR_TIME struEndTime;//ÊÂ¼þÍ£Ö¹µÄÊ±¼ä£¬Âö³åÊÂ¼þÊ±ºÍ¿ªÊ¼Ê±¼äÒ»Ñù
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
            public byte[] byChan;
        ...
        public struct NET_DVR_SPRCFG
        {
            ...
            public byte bySendsdkImage;  	//ÊÇ·ñ·¢ËÍ³µÅÆ¶þÖµÍ¼£º0-²»·¢ËÍ£¬1-·¢ËÍ 
        ...
        {
            public uint dwSize;
            public uint dwMatrixId;  /*¾ØÕó±àºÅ*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sDevName;
            public byte byCtrlType; /*Ö¸Í¨Ñ¶·½Ê½ÊÇ´®¿ÚÍ¨ÐÅ, »¹ÊÇÍøÂçÍ¨ÐÅ*/
            public byte byProtocolType;/*ÉèÖÃÍ¨ÐÅ¿ØÖÆÐ­Òé*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;   /*Ô¤Áô*/
            public NET_MATRIX_UNION struMatrixUnion;
            public uint dwMaxPortsIn; /*¾ØÕóÊäÈëÊý*/
            public uint dwMaxPortsOut;/*¾ØÕóÊä³öÊý*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_VCA_FACESNAP_INFO_ALARM
        {
            ...
            public NET_VCA_DEV_INFO struDevInfo;//ÈËÁ³×¥ÅÄÉÏ´«ÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;//±£Áô
        ...
        {
            public uint dwSize;
            public float fSimilarity;//ÏàËÆ¶È£¬È¡Öµ·¶Î§£º[0.001,1]
            public NET_VCA_FACESNAP_INFO_ALARM struSnapInfo;//ÈËÁ³×¥ÅÄÉÏ´«ÐÅÏ¢
        ...
        {
            public byte byDecodeEnable;//½âÂëÆðÍ£±êÖ¾£¬0-Í£Ö¹£¬1-ÆôÓÃ¶¯Ì¬½âÂë£¬2-ÆôÓÃÂÖÑ²½âÂë
            public byte bySlotNum;//²ÛÎ»ºÅ
            public byte byDecChan;
            public byte byJointAllDecodeChan;		//ÊÇ·ñ¹ØÁªÍòÄÜ½âÂëÍ¨µÀ 0-²»¹ØÁª£¬1-¹ØÁª
            public byte byJointSlotNum;			//¹ØÁªµÄ²ÛÎ»ºÅ£¨ÍòÄÜ½âÂë°åµÄ²ÛÎ»ºÅ£©
            public byte byJointChanNum;		//¹ØÁªµÄÍ¨µÀºÅ£¨ÍòÄÜ½âÂë°åÍ¨µÀºÅ£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        ...
        ******************************************************************************/
        ...
        [DllImportAttribute(@"sdk\HCNetSDK.dll")]
